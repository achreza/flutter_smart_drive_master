...
class Forum extends StatefulWidget {
  Forum({Key? key, required this.namauser}) : super(key: key);
  String namauser;
  Color? _colors = null;

  @override
  _ForumState createState() => _ForumState(namauser: namauser);
}

class _ForumState extends State<Forum> {
  String namauser;
  _ForumState({required this.namauser});
  ...
  Future getData() async {
    var url =
        Uri.parse('https://lugingaweflutter.000webhostapp.com/getChat.php');
...
//     });
  ...
  Color _color(String nama) {
    if (nama == namauser) {
      return HexColor('#31a559');
    } else {
      return HexColor("#3B4254");
    }
  }
